      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        <div>
          ...
          <div className="flex gap-4">
            <a href="https://instagram.com/youth__care" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 hover:bg-gold/10 hover:text-gold rounded-full transition-all duration-300" aria-label="Instagram">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
            </a>
            <a href="https://facebook.com/p/Youth-Care-100079715082112/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 hover:bg-gold/10 hover:text-gold rounded-full transition-all duration-300" aria-label="Facebook">
            ...
            <a href="https://www.youtube.com/@Youth_Care" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 hover:bg-gold/10 hover:text-gold rounded-full transition-all duration-300" aria-label="YouTube">
